...
- Многопоточность
- Архивирование файлов размером до 32MB
...
- Любая POSIX совместимая файловая система с полноценной подддержкой блокировок (предпочтительна кластерная MooseFS)
...
- Максимально возможный размер параметра fmaxsize = 33554432 байт
