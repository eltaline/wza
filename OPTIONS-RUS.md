...
- -show string
        --show=/path/to/file.bolt - показывает регулярные файлы и/или ключи в Bolt архиве
- -skeyscnt int
        --skeyscnt=16384 - максимально допустимое количество файлов и/или ключей на один Bolt архив (авто-шардинг файлов в директории). Максимальное значение: 131072 файла / ключа (по умолчанию 16384)
- -smaxsize int
        --smaxsize=536870912 - максимально допустимый размер Bolt архива (авто-шардинг файлов в директории). Максимальное значение: 1073741824 байта (по умолчанию 536870912)
- -threads int
